...
*/
    ...
    tf_subscription = nh.subscribe("/svh/joint_states", 1000, subJointStatesCallback);
    ...
    // Debug channel (1000 e' la capienza del buffer)
    debug_pub = nh.advertise<std_msgs::String>("/antonio_debug", 1000);
